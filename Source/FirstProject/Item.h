...
public:	
	...
	// "UParticleSystemComponent" in general need to be constructed with CreateDefaultSubObject
	// Whereas, "UParticleSystem" does not
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item | Particles")
	UParticleSystemComponent* IdleParticlesComponent;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item | Particles")
	UParticleSystem* OverlapParticles; // no need to construct

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item | Sounds")
	USoundCue* OverlapSound; // no need to construct
